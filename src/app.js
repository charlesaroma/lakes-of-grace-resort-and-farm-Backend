...
import feedbackRoutes from './features/crm/feedback/feedback.routes.js';
import notificationRoutes from './features/crm/notifications/notification.routes.js';
import roomPricingRoutes from './features/crm/roomCategories/roomPricing.routes.js';
...
import procurementRoutes from './features/crm/procurement/procurement.routes.js';
...
app.use('/api/crm/feedback', feedbackRoutes);
app.use('/api/crm/notifications', notificationRoutes);
app.use('/api/crm/room-pricing', roomPricingRoutes);
...
app.use('/api/crm/procurement', procurementRoutes);
